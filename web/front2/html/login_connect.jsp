...
<body>
	...
	<div class="wrapper_index">
		...
		<div class="main">
			...
			<div class="main_up_middle_top" style="cursor: pointer;" onclick="location.href='https://www.apple.com/kr/?afid=p238%7CsiADh6hbK-dc_mtid_18707vxu38484_pcrid_620523511820_pgrid_16348496961_pntwk_g_pchan__pexid__&cid=aos-kr-kwgo-Brand--slid---product-';"></div>
			<div class="main_up_middle_middle">5</div>
			<div class="main_up_middle_bottom" style="cursor: pointer;" onclick="location.href='https://www.bhc.co.kr/mobile/';"></div>

			<%-- main_middle 움지이고 싶으면 main_middle 이용하기 --%>
			<div class="main_middle"></div>
			<div class="main_middle_top"></div>
			<div class="main_middle_middle">8</div>
			<div class="main_middle_bottom" style="cursor: pointer;" onclick="location.href='https://goodrichmall.com/total_sum?inType=GKAB&gclid=EAIaIQobChMIgKTzh-eY-gIV1KmWCh24rAiZEAAYASAAEgLn_PD_BwE';"></div>

			<%-- main_bottomd 움직이고 싶으면 main_bottom 이용하기 --%>
			<div class="main_bottom"><a href="">자산 배분을 위한 솔루션</a></div>
		...
		<div class="footer">
			...
			<div class="footer_bottom_bottom">
				...
				<div class="footer_bottom_bottom_middle">
					<button>
						<a href="https://www.facebook.com/campaign/landing.php?&campaign_id=1654655180&extra_1=s%7Cc%7C318651279253%7Ce%7Cfacebook%27%7C&placement=&creative=318651279253&keyword=facebook%27&partner_id=googlesem&extra_2=campaignid%3D1654655180%26adgroupid%3D63137639963%26matchtype%3De%26network%3Dg%26source%3Dnotmobile%26search_or_content%3Ds%26device%3Dc%26devicemodel%3D%26adposition%3D%26target%3D%26targetid%3Dkwd-362360550869%26loc_physical_ms%3D1009871%26loc_interest_ms%3D%26feeditemid%3D%26param1%3D%26param2%3D&gclid=EAIaIQobChMIpKbnrvSY-gIV1cIWBR15NQ3OEAAYASAAEgL-ovD_BwE"><i class="fa-brands fa-square-facebook fa-2x"></i></a>
					</button>
					<button>
						<a href="https://www.instagram.com/"><i class="fa-brands fa-square-instagram fa-2x"></i></a>
					</button>
					<button>
						<a href="https://twitter.com/i/flow/login"><i class="fa-brands fa-square-twitter fa-2x"></i></a>
					</button>
				</div>
			</div>
		</div>
