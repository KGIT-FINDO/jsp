	...
	<div class="wrapper_index">
		...
		<div class="header">
			...
			<div class="header_middle">
				<a href="./index.jsp"><input type="button" value="홈" /></a> <a
					href="./index_portfolio.jsp"><input type="button" value="포트폴리오" /></a>
				<a href="./index_community.jsp"><input type="button"
					value="커뮤니티" /></a> <a href="./index_news.jsp"><input
