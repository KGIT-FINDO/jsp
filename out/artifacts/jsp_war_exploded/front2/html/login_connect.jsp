...
<div class="wrapper_index">
	...
	<div class="header">
		...
		<div class="header_middle">
			<a href="/front2/html/login_connect.jsp"><input type="button" value="홈" /></a>
